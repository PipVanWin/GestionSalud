namespace GestionSalud.Presentacion
{
    partial class FormAsignacionEnseres
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.grpFiltro.Controls.AddRange(new System.Windows.Forms.Control[] {
                this.lblCentro, this.cboCentro, this.lblEspacio, this.cboEspacio, this.lblEquiposAsign });

            this.lblCentro.Text      = "Centro de Salud:";
            this.lblCentro.AutoSize  = true;
            this.lblCentro.Location  = new System.Drawing.Point(10, 28);

            this.cboCentro.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
            this.cboCentro.Location      = new System.Drawing.Point(120, 25);
            ...
            this.lblEspacio.Location = new System.Drawing.Point(360, 28);

            this.cboEspacio.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
            this.cboEspacio.Location      = new System.Drawing.Point(470, 25);
            ...
            this.lblEquiposAsign.Location = new System.Drawing.Point(710, 28);
            ...
            this.lblInfo.Text      = "Equipos disponibles (sin asignar) — use Ctrl+clic para selección múltiple:";
            ...
            this.grpAcciones.Controls.AddRange(new System.Windows.Forms.Control[] {
                this.btnAsignar, this.btnHojaInventario, this.btnRefrescar });
