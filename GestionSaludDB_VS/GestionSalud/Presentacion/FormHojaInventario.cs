...
{
    /// <summary>
    /// Muestra e imprime la hoja de inventario de un espacio.
    ///
    /// Controles que debes crear en el diseñador:
    ///   lblTitulo      — Label  (encabezado con nombre de centro/espacio)
    ///   lblFecha       — Label  (fecha de generación)
    ///   dgvHoja        — DataGridView (ReadOnly = true)
    ///   lblFirma       — Label  (texto: "Firma del Responsable: ___________")
    ///   btnImprimir    — Button ("Imprimir")
    ///   btnCerrar      — Button ("Cerrar")
    /// </summary>
